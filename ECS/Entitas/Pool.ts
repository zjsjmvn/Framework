import { Entity, EntityReleased, EntityChanged, ComponentReplaced } from "./Entity";
...
export class Pool {
   ...
   * @type {entitas.utils.ISignal} */
  public onGroupCreated: IGroupChanged<GroupChanged> = null
   ...
   */
  public createEntity(name: string,type): Entity {
    const entity = this._reusableEntities.size() > 0 ? this._reusableEntities.removeLast() : new type(this._componentsEnum, this._totalComponents)
