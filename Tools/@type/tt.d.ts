declare namespace tt {
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/render/canvas/tt.createCanvas.html
     */
     ...
     * 创建一个图片对象
     * 
     * https://developers.weixin.qq.com/minigame/dev/api/render/image/tt.createImage.html
     */
    ...
    /**
     * 获取系统信息
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getSystemInfo.html
     * 
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getSystemInfoSync.html
     * 
     * @returns {SystemInfo}
     */
    ...
    /**
     * 检查登录态是否过期。  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.checkSession.html  
        通过 `tt.login` 接口获得的用户登录态拥有一定的时效性。用户越久未使用小程序，用户登录态越有可能失效。反之如果用户一直在使用小程序，则用户登录态一直保持有效。具体时效逻辑由微信维护，对开发者透明。开发者只需要调用 tt.checkSession 接口检测当前用户登录态是否有效。

        登录态过期后开发者可以再调用 tt.login 获取新的用户登录态。调用成功说明当前 session_key 未过期，调用失败说明 session_key 已过期。更多使用方法详见 [小程序登录](https://developers.weixin.qq.com/minigame/dev/tutorial/open-ability/login.html)。
     * 
     * @param param 
     * 
     * @example
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/tt.login.html
     * 
     ...
     * 
     * https://developers.weixin.qq.com/minigame/dev/api/tt.request.html
     * 
     * @example 
     * tt.request({
    ...
    /**
     * 米大师可用支付金额
     * [buyQuantity 限制说明](https://developers.weixin.qq.com/minigame/dev/document/midas-payment/tt.requestMidasPayment.html#buyquantity-%E9%99%90%E5%88%B6%E8%AF%B4%E6%98%8E)
     *
     * @
     * @enum {number}
     */
    ...
    /**
     * 获取转发详细信息  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getShareInfo.html
     * @param param 
     */
    ...
    /**
     * 隐藏转发按钮  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.hideShareMenu.html
     * @param callback 
     */
    ...
    interface ShareAppMessageParam {
        ...
        imageUrl?: string;
        /**
         * 查询字符串，从这条转发消息进入后，可通过 tt.onLaunch() 或 tt.onShow 获取启动参数中的 query。必须是 key1=val1&key2=val2 的格式。
         *
         * @type {string}
         * @memberof ShareAppMessageParam
         */
    ...
    /**
     * 显示当前页面的转发按钮
     * https://developers.weixin.qq.com/minigame/dev/api/tt.showShareMenu.html  
     * 
     * @example
     * tt.showShareMenu({
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/tt.onShareAppMessage.html
     * 
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/tt.offShareAppMessage.html
     * 
     * @param {({})} callback
     */
    ...
    /**
     * 主动拉起转发，进入选择通讯录界面。
     * https://developers.weixin.qq.com/minigame/dev/api/tt.shareAppMessage.html
     * 
    ...
    /**
     * 更新转发属性
     * https://developers.weixin.qq.com/minigame/dev/api/tt.updateShareMenu.html
     * @param param 
     * 
     * @example
     * tt.updateShareMenu({
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getUpdateManager.html
     * 获取更新管理器对象
     *
    ...
    /**
     * 小程序跳转  
     * https://developers.weixin.qq.com/minigame/dev/document/open-api/miniprogram-navigate/tt.navigateToMiniProgram.html  
     * 
    ...
    /**
     * 创建激励视频广告组件。
     * https://developers.weixin.qq.com/minigame/dev/document/ad/tt.createRewardedVideoAd.html
     * 
     * 支持版本 >= 2.0.4
     *
     * 请通过 `tt.getSystemInfoSync()` 返回对象的 SDKVersion 判断基础库版本号  >= 2.0.4 后再使用该 API。同时，开发者工具上暂不支持调试该 API，请直接在真机上进行调试。
     *
     * @
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/tt.createBannerAd.html
     * 
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/tt.exitMiniProgram.html
     * 退出当前小游戏
     * @param callback 
     */
     ...
     * * 对于小游戏，可以在 tt.getLaunchOptionsSync 和 tt.onShow 中获取上述场景值
部分场景值下还可以获取来源应用、公众号或小程序的appId。  
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getLaunchOptionsSync.html
     * 启动属性
     */
    ...
    /**
     * 取消监听小游戏隐藏到后台事件  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.offHide.html
    ...
    /**
     * 取消监听小游戏回到前台的事件  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.offShow.html
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/tt.onHide.html
     * @param callback 小游戏隐藏到后台事件的回调函数
     */
    ...
    /**
     * 进入客服会话
     * https://developers.weixin.qq.com/minigame/dev/api/tt.openCustomerServiceConversation.html
    ...
    /**
     * 获取设备电量。 在 iOS 上不可用。  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getBatteryInfo.html
     * 实际测试，此API在ios上不可用
     */
    ...
    /**
     * 获取设备电量的同步版本  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getBatteryInfoSync.html
     */
    ...
    /**
     * 设置系统剪贴板的内容  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.setClipboardData.html
     * 
     * @version >1.1.0
     * 
     * @param obj 
    ...
    /**
     * 获取系统剪贴板的内容  
     * https://developers.weixin.qq.com/minigame/dev/api/tt.getClipboardData.html
     * 
     * @version >1.1.0
     * @param obj 
     * 
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/tt.previewImage.html  
     * 
     * @param opt 
     * 
     * @example
    ...
    const enum AuthorizeScope {
        ...
        /**
         * 微信运动步数  
         * 对应接口 `tt.getWeRunData`  
         */
        WeRun = "scope.werun",
        /**
         * 保存到相册  
         * 对应接口 `tt.saveImageToPhotosAlbum`
         */
    ...
    /**
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/authorize/tt.authorize.html
     * https://developers.weixin.qq.com/minigame/dev/guide/framework/authorize.html
     * 
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/setting/tt.getSetting.html
     * @param opt 
     * 
     * @example
     * tt.getSetting({
    ...
    interface CreateUserInfoButtonParam {
        ...
        /**
         * 是否带上登录态信息。当 withCredentials 为 true 时，要求此前有调用过 tt.login 且登录态尚未过期，此时返回的数据会包含 encryptedData, iv 等敏感信息；当 withCredentials 为 false 时，不要求有登录态，返回的数据不包含 encryptedData, iv 等敏感信息
         */
    ...
    /**
     * 创建用户信息按钮  
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/user-info/tt.createUserInfoButton.html  
     * @version >= 2.0.1
     * @param param 
     * 
     * @example
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/user-info/tt.getUserInfo.html
     * @param param 
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.setUserCloudStorage.html  
     * 
     * @version >= 1.9.92
     * 
     * ## 托管数据的限制  
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.removeUserCloudStorage.html  
     * 
     * @version >= 1.9.92  
     * 
     * @param param 
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.getUserCloudStorage.html  
     * @param param 
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.getSharedCanvas.html
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.getGroupCloudStorage.html
     * @param param 
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/tt.getFriendCloudStorage.html
     * @param param 
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/data/OpenDataContext-tt.getUserInfo.html  
     * @param param 
     */
    ...
    /**
     * 获取开放数据域  
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/context/tt.getOpenDataContext.html  
     * 
     * @version >= 1.9.92
     */
     ...
     * https://developers.weixin.qq.com/minigame/dev/api/open-api/anti-addiction/tt.checkIsUserAdvisedToRest.html  
     * 
     * @version >=1.9.97
     * 
     * @param param 
